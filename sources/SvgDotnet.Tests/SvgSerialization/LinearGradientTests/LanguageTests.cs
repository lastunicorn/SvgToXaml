...
public class LanguageTests : LanguageTestsBase<SvgLinearGradient>
{
    protected override SvgLinearGradient SelectElementToTest(Svg svg)
    {
        SvgDefinitions svgDefinitions = svg.Children[0] as SvgDefinitions;
        return svgDefinitions.Children[0] as SvgLinearGradient;
    }
}