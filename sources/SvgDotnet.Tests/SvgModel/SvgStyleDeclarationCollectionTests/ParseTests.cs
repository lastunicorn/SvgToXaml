...
namespace DustInTheWind.SvgDotnet.Tests.SvgModel.SvgStyleDeclarationCollectionTests;
...
public class ParseTests
{
    ...
    public void HavingOnePairWellFormatted_WhenParsed_ThenCollectionContainsOnePairWithCorrectValues()
    {
        ...
        styleDeclarationCollection[0].Name.Should().Be("name1");
        styleDeclarationCollection[0].Value.Should().Be("value1");
    }
