...
public class Constructor_SvgLengthPositiveTests
{
    ...
    [Fact]
    public void HavingPositiveMillimetersLength_WhenCreatingInstanceFromIt_ThenIsEmptyIsFalse()
    {
    ...
    [Fact]
    public void HavingPositiveMillimetersLength_WhenCreatingInstanceFromIt_ThenPercentageIsNull()
    {
        lengthPercentage.Percentage.Should().BeNull();
    }

    [Fact]
    public void HavingPositiveMillimetersLength_WhenCreatingInstanceFromIt_ThenIsNegativeIsFalse()
    {
