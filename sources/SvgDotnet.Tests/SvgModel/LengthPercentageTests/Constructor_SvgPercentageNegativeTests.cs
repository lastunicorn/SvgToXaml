...
public class Constructor_SvgPercentageNegativeTests
{
    private readonly LengthPercentage lengthPercentage;

    public Constructor_SvgPercentageNegativeTests()
    {
    ...
    [Fact]
    public void HavingPositivePercentage_WhenCreatingInstanceFromIt_ThenIsNegativeIsTrue()
    {
