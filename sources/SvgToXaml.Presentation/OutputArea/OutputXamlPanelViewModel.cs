...
public class OutputXamlPanelViewModel : ViewModelBase
{
    ...
    public OutputXamlPanelViewModel(EventBus eventBus, CopyToClipboardCommand copyToClipboardCommand)
    {
        if (eventBus == null) throw new ArgumentNullException(nameof(eventBus));

        CopyToClipboardCommand = copyToClipboardCommand ?? throw new ArgumentNullException(nameof(copyToClipboardCommand));
