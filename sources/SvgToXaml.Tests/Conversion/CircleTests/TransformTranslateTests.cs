...
public class TransformTranslateTests : SvgFileTestsBase
{
    ...
    public void HavingCircleWithTranslateValuesPositive_WhenSvgIsParsed_ThenResultedEllipseHasCorrectRenderTransformInformation()
    {
        ConvertSvgFile("transform-translate-positive.svg", canvas =>
        {
            ...
            TranslateTransform translateTransformLocation = transformGroup.Children[0] as TranslateTransform;
            translateTransformLocation.X.Should().Be(270);
            translateTransformLocation.Y.Should().Be(170);
