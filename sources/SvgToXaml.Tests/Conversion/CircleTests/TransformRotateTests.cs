...
{
    [Fact]
    public void HavingCircleWithRotateAngle15_WhenSvgIsParsed_ThenResultedRectangleHasTranslateTransformAndRotateTransform()
    {
    ...
    [Fact]
    public void HavingCircleWithRotateAngle15AndRotationPoint_WhenSvgIsParsed_ThenResultedRectangleHasTranslateTransformAndRotateTransform()
    {
    ...
    [Fact]
    public void HavingCircleWithCx150AndRotateAngle15_WhenSvgIsParsed_ThenResultedRectangleHasTranslateTransformAndRotateTransform()
    {
    ...
    [Fact]
    public void HavingCircleWithCx150AndRotateAngle15AndRotateCx90_WhenSvgIsParsed_ThenResultedRectangleHasTranslateTransformAndRotateTransform()
    {
