...
namespace DustInTheWind.SvgToXaml.Tests.Conversion.StrokeTests.UseHrefDefsGroupWithCircleTests;
...
public class UseHrefDefsGroupWithCircleTests : SvgFileTestsBase
{
    ...
    {
        TestConvertSvgFile("01-use-href-defs-group-circle^.svg", canvas =>
        {
    ...
    {
        TestConvertSvgFile("02-use-href-defs-group^-circle.svg", canvas =>
        {
            Ellipse ellipse = canvas
                .GetElementByIndex<Canvas>(0)
                .GetElementByIndex<Ellipse>(0);
    ...
    {
        TestConvertSvgFile("03-use^-href-defs-group-circle.svg", canvas =>
        {
            Ellipse ellipse = canvas
                .GetElementByIndex<Canvas>(0)
                .GetElementByIndex<Ellipse>(0);
    ...
    {
        TestConvertSvgFile("04-use-href-defs-group^-circle^.svg", canvas =>
        {
            Ellipse ellipse = canvas
                .GetElementByIndex<Canvas>(0)
                .GetElementByIndex<Ellipse>(0);
    ...
    {
        TestConvertSvgFile("05-use^-href-defs-group-circle^.svg", canvas =>
        {
            Ellipse ellipse = canvas
                .GetElementByIndex<Canvas>(0)
                .GetElementByIndex<Ellipse>(0);
    ...
    {
        TestConvertSvgFile("06-use^-href-defs-group^-circle.svg", canvas =>
        {
            Ellipse ellipse = canvas
                .GetElementByIndex<Canvas>(0)
                .GetElementByIndex<Ellipse>(0);
    ...
    {
        TestConvertSvgFile("07-use^-href-defs-group^-circle^.svg", canvas =>
        {
            Ellipse ellipse = canvas
                .GetElementByIndex<Canvas>(0)
                .GetElementByIndex<Ellipse>(0);
