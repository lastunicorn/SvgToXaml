...
namespace DustInTheWind.SvgToXaml.Tests.Conversion.FillTests.ColorTests;

public class ColorTests : SvgFileTestsBase
{
    [Fact]
    public void HavingFillSpecifiedAsRgbColorOf6Digits_WhenSvgIsParsed_ThenResultedEllipseHasCorrectFillColor()
    {
        TestConvertSvgFile("circle-fill-rgb-full.svg", canvas =>
        {
    ...
    {
        TestConvertSvgFile("circle-fill-rgb-short.svg", canvas =>
        {
            Ellipse ellipse = canvas
                .GetElementByIndex<Ellipse>(0);
    ...
    {
        TestConvertSvgFile("circle-fill-argb.svg", canvas =>
        {
            Ellipse ellipse = canvas
                .GetElementByIndex<Ellipse>(0);
